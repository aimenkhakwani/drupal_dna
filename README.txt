...
DNA Helix is a site in Drupal 7.  It has Drupal functional and unit testing, and uses ajax in a custom module. The site has a custom module that takes a input of the first half of a DNA strand and returns the corresponding strand.
